...
_0x0:
	.DB  0x54,0x69,0x6D,0x65,0x72,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0038 // TCNT1H=0x0796 >> 8;
; 0000 0039 // TCNT1L=0x0796 & 0xff;
; 0000 003A TCNT1H=0x001E >> 8;
	LDI  R30,LOW(0)
	OUT  0x2D,R30
; 0000 003B TCNT1L=0x001E & 0xff;
	LDI  R30,LOW(30)
	OUT  0x2C,R30
; 0000 003C 
; 0000 003D if (running) {
	TST  R9
	BREQ _0xB
; 0000 003E     tick();
	RCALL _tick
...
_0xB:
	RCALL _lcd_clear
; 0000 0041     lcd_gotoxy(6, 0);
	LDI  R30,LOW(6)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0042     lcd_puts("Timer");
	__POINTW2MN _0xC,0
	RCALL _lcd_puts
; 0000 0043     lcd_gotoxy(3, 1);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 0044     putnum(hr / 10);
	MOV  R26,R5
	RCALL SUBOPT_0x0
; 0000 0045     putnum(hr % 10);
	MOV  R26,R5
	RCALL SUBOPT_0x1
; 0000 0046     lcd_putchar(':');
; 0000 0047     putnum(min / 10);
	MOV  R26,R4
	RCALL SUBOPT_0x0
; 0000 0048     putnum(min % 10);
	MOV  R26,R4
	RCALL SUBOPT_0x1
; 0000 0049     lcd_putchar(':');
; 0000 004A     putnum(sec / 10);
	MOV  R26,R7
	RCALL SUBOPT_0x0
; 0000 004B     putnum(sec % 10);
	MOV  R26,R7
	RCALL SUBOPT_0x1
; 0000 004C     lcd_putchar(':');
; 0000 004D     putnum(decsec);
	MOV  R26,R6
	CLR  R27
	RCALL _putnum
; 0000 004E 
...
; 0000 0067 // Timer Period: 50 ms
; 0000 0068 // Timer1 Overflow Interrupt: On
...
; 0000 006C TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 006D TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (1<<CS11) | (0<<CS10);
	LDI  R30,LOW(2)
	OUT  0x2E,R30
; 0000 006E TCNT1H=0x3C;
	LDI  R30,LOW(60)
	OUT  0x2D,R30
; 0000 006F TCNT1L=0xB0;
	LDI  R30,LOW(176)
	OUT  0x2C,R30
...
; 0000 0078 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(4)
	OUT  0x39,R30
; 0000 0079 
; 0000 007A // External Interrupt(s) initialization
; 0000 007B // INT0: On
; 0000 007C // INT0 Mode: Low level
; 0000 007D // INT1: On
; 0000 007E // INT1 Mode: Low level
; 0000 007F // INT2: Off
; 0000 0080 GICR|=(1<<INT1) | (1<<INT0) | (0<<INT2);
	IN   R30,0x3B
	ORI  R30,LOW(0xC0)
	OUT  0x3B,R30
...
; 0000 0082 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 0083 GIFR=(1<<INTF1) | (1<<INTF0) | (0<<INTF2);
	LDI  R30,LOW(192)
	OUT  0x3A,R30
; 0000 0084 
...
; 0000 0089 // RD - PORTA Bit 1
; 0000 008A // EN - PORTA Bit 2
